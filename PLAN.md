...
| **HEP-16** · Sản xuất toàn bộ biểu đồ + bảng | P5 | 1.5d | HEP-13 | Box plot log loss, heatmap p-value, bảng tổng hợp; đóng gói đầy đủ vào `figures/` + `tables/`, đặt tên rõ | ✅ 4 hình trong `figures/report/`, `tables/report_*.csv\|.tex`, notebook 07 |
